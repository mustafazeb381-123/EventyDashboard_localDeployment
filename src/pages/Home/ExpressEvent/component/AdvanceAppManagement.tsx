...
export default function AdvanceAppManagement() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-7xl">
          ...
          <div className="lg:sticky lg:top-6 h-fit">
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              ...
              {/* Next Button */}
              <div className="mt-6">
                <button className="w-full bg-indigo-950 text-white py-3 rounded-lg font-medium hover:bg-indigo-900 transition-colors flex items-center justify-center gap-2">
                  Next
                  <span>→</span>
                </button>
              </div>
