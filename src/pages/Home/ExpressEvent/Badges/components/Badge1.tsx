...
const Badge1: React.FC<Badge1Props> = ({ badge, event, onClose, CardHeader, CardFooter }) => {
                ...
                <div className="flex flex-col justify-center items-center sm:flex-row gap-6">
                    ...
                    <div className="flex flex-col h-[100vh] w-full rounded-xl border-1">
                        ...
                        <div className="flex flex-1 flex-col justify-center items-center">
                            <img src={badge.userImg} className="w-48 rounded-full object-cover" />
                    ...
                    <div className="flex flex-col h-[100vh] w-full rounded-xl border-1">
                        ...
                        <div className="flex flex-1 flex-col justify-center items-center">
                            ...
                            <img src={badge.qrImg} className="h-50" alt="QR Code" />
                        </div>
