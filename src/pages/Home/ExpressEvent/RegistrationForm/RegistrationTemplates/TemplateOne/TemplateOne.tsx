  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 mt-4">
      <div className="w-full md:w-1/2">
        <img src={Assets.images.templateOne} />
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-between">
        ...
        <button  onClick={navigationHandle} className="cursor-pointer bg-slate-800 text-white p-3 rounded-lg text-sm font-poppins font-medium hover:bg-slate-900 transition-colors">
          Use Template →
        </button>
      </div>
    </div>
