    ...
    <div className="w-full flex flex-row p-4">
      <div className=" w-[30%] mr-3 flex flex-col  items-center">
        ...
        <div className="w-full " style={{ width: "100%" }}>
          ...
          <p className="text-slate-800 text-xs font-poppins font-medium">
            Lorem ipsum dolor sit amet consectetur. Penatibus sit nisl mattis
            non odio vestibulum euismod eget id. Ac quam vulputate sed eget
            montes tincidunt. Imperdiet sagittis eu imperdiet facilisi leo
            aliquet amet neque in. Ultrices lacus condimentum vel augue elit
            sodales iaculis.
          </p>
        </div>
      </div>
