...
const TemplateTwo = ({
  ...
  const handleUseTemplate = () => {
    console.log("TemplateTwo handleUseTemplate");
    if (onUseTemplate && !isLoading) {
      // Call the parent function with template data
      onUseTemplate("template-two", {
        name: "Event Registration Form Template Two",
        description:
          "A stylish registration form template with modern design elements for collecting attendee information.",
