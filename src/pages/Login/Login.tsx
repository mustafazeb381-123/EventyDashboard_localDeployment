...
function Login() {
  ...
  const validate = () => {
    ...
    else if (password.length <= 5) newErrors.password = "Password should be atleast 6 digits"
    setErrors(newErrors);
  ...
  return (
    <div className="p-10">
      <div  style={{ background: 'linear-gradient(150deg,rgba(228, 230, 238, 1) 1%, rgba(255, 255, 255, 1) 29%)',
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center px-4 py-8">
          ...
          <p style={{fontSize:48}} className='mt-10 font-poppins font-semibold text-gray-900'>Welcome 👋</p>
          <div className="mt-10 w-full max-w-sm space-y-4">
            ...
            />
            {errors.email && <p className="text-red-500 text-xs font-poppins">{errors.email}</p>}
            ...
            {errors.password && <p className="text-red-500 text-xs font-poppins">{errors.password}</p>}
