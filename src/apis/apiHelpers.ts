 ...
 * 
 * Backend Endpoint: POST /events/:eventId/payments/initiate
 * 
 * Request Body:
 * {
 *   amount: string,
 ...
 * Response:
 * {
 *   publicKey: string,      // Tap public key
 *   merchantId: string,     // Tap merchant ID
 *   hashString: string,     // Hash string for payment security
 *   transactionId: string,  // Your transaction ID (if generated by backend)
 *   orderId: string         // Your order ID (if generated by backend)
 * }
 */
export const initiateTapPayment = (
  eventId: string | number,
  paymentData: {
    amount: string;
    currency: string;
 ...
 * Verify Tap Payment
 * 
 * Backend Endpoint: POST /events/:eventId/payments/verify
 * 
 * Request Body:
 * {
 *   transactionId: string,      // Your internal transaction ID
 *   tapTransactionId: string,    // Tap's transaction ID from onSuccess callback
 *   paymentData: object         // Full payment response from Tap
 * }
 * 
 * Response:
 * {
...
export const verifyTapPayment = (
  ...
  return axiosInstance.post(
    `/events/${eventId}/payments/verify`,
    {
      payment_verification: verificationData,
    }
  );
};
 ...
 * Get Payment Status
 * 
 * Backend Endpoint: GET /events/:eventId/payments/:transactionId/status
 * 
 * Response:
 * {
...
export const getPaymentStatus = (
  ...
  return axiosInstance.get(
    `/events/${eventId}/payments/${transactionId}/status`
  );
};

/**
 * Get Payment History for Event
 * 
 * Backend Endpoint: GET /events/:eventId/payments
 * 
