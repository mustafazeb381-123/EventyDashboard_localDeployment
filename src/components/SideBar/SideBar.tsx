      ...
      <aside className={`fixed ${isRTL ? 'right-0' : 'left-0'} top-0 h-screen bg-gradient-to-b from-slate-800 via-slate-900 to-blue-900 shadow-2xl transition-all duration-300 ease-in-out z-50 ${
        ...
        {isExpanded && (
          <div className="px-4 py-4 border-b">
            <div className="flex items-center">
              <Button onClick={() => setIsExpanded(!isExpanded)} className=" h-2/3  flex flex-row items-center justify-evenly">
                <img src={Assets.icons.leftArrow} height={24} width={24} />
                <img src={Assets.images.sidebarExpandedLogo} className="w-30 h-1/2" alt="" />
        ...
        {!isExpanded && (
          <div className="px-4 py-4 border-b border-slate-700/50 flex justify-center">
            <Button onClick={() => setIsExpanded(!isExpanded)} className="h-20 w-20" >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-2 border-t border-slate-700/50 space-y-2 bg-gradient-to-b from-slate-900 to-blue-900">
          <Button
            variant="ghost"
            className={`w-full ${isExpanded ? 'justify-start px-3' : 'justify-center px-3'} py-2.5 text-slate-300 hover:bg-slate-700/50 hover:text-white rounded-lg`}
          >
          ...
          <Button
            ...
            variant="ghost"
            className={`w-full ${isExpanded ? 'justify-start px-3' : 'justify-center px-3'} py-2.5 text-red-400 hover:bg-red-900/20 hover:text-red-300 rounded-lg`}
          >
