          ...
          <div className="col-span-2 border-r bg-gradient-to-b from-gray-50 to-white p-4 overflow-auto">
            ...
            <div className="border-t pt-4 mt-6">
              ...
              <div className="space-y-2">
                <button
                  type="button"
                  className="w-full p-2 text-left rounded-lg border border-gray-200 bg-white hover:border-pink-300 hover:bg-pink-50 transition-colors text-xs font-medium text-gray-700 hover:text-pink-700"
                  onClick={() => setDesign(defaultDesignFromHtml(""))}
                >
                  📝 Blank Template
                </button>
                <button
                  ...
                  className="w-full p-2 text-left rounded-lg border border-gray-200 bg-white hover:border-pink-300 hover:bg-pink-50 transition-colors text-xs font-medium text-gray-700 hover:text-pink-700"
                  onClick={() => {
                    const welcome: EmailTemplateDesign = {
                      ...defaultDesignFromHtml(""),
                      blocks: [
                        {
                          id: uid("h"),
                          type: "heading",
                        ...
                        },
                        {
                          id: uid("img"),
                          type: "image",
                          src: "https://via.placeholder.com/600x240.png?text=Welcome",
                          alt: "Welcome",
                          width: 520,
                          align: "center",
                          borderRadius: 12,
                        },
                        {
                          id: uid("p"),
                          type: "paragraph",
                          html: "<p style='text-align: center'>Thanks for joining us! We're excited to have you.</p>",
                          align: "center",
                          color: "#6b7280",
                          fontSize: 16,
                          lineHeight: 1.6,
                        ...
                        { id: uid("sp"), type: "spacer", height: 32 },
                        {
                          id: uid("social"),
                          type: "social",
                          icons: [
            ...
            <div className="mt-4 space-y-2">
              <button
                type="button"
                onClick={() => {
                  if (selectedBlock) duplicateBlock(selectedBlock.id);
                }}
                className="w-full flex items-center justify-center gap-2 border border-blue-200 text-blue-600 rounded-lg px-3 py-2 text-sm font-medium hover:bg-blue-50 transition-colors disabled:opacity-40"
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 border border-red-200 text-red-600 rounded-lg px-3 py-2 text-sm font-medium hover:bg-red-50 transition-colors disabled:opacity-40"
                disabled={!selectedBlock}
              >
                <Trash2 size={15} />
                Delete
            ...
            {!selectedBlock ? (
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:border-pink-400 focus:ring-1 focus:ring-pink-400 outline-none"
                ...
                <div>
                  ...
                  <AlignmentButtons
                    value={(selectedBlock as HeadingBlock).align}
                    onChange={(v) => updateSelected({ align: v } as any)}
                  />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        type="color"
                        className="w-10 h-10 border border-gray-200 rounded-lg cursor-pointer"
                        value={(selectedBlock as HeadingBlock).color}
                        onChange={(e) =>
                  ...
                  <div>
                    ...
                    <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                      <input
                        type="number"
                        className="flex-1 px-3 py-2 text-sm outline-none"
                        value={(selectedBlock as HeadingBlock).fontSize}
                        onChange={(e) =>
                          updateSelected({
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <RichTextEditor
                    value={(selectedBlock as ParagraphBlock).html}
                    onChange={(html) => updateSelected({ html } as any)}
                    mergeTags={mergeTags}
                  />
                </div>
                <div>
                  ...
                  <AlignmentButtons
                    value={(selectedBlock as ParagraphBlock).align}
                    onChange={(v) => updateSelected({ align: v } as any)}
                  />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                      <input
                        type="number"
                        className="flex-1 px-3 py-2 text-sm outline-none"
                        value={(selectedBlock as ParagraphBlock).fontSize}
                        onChange={(e) =>
                          updateSelected({
                            fontSize: Number(e.target.value),
                          } as any)
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={(selectedBlock as ParagraphBlock).lineHeight}
                      onChange={(e) =>
                        updateSelected({
              ...
              <QRCodeBlockSettings
                block={selectedBlock as QRCodeBlock}
                onUpdate={updateSelected}
              />
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:border-pink-400 outline-none"
                    value={(selectedBlock as ButtonBlock).text}
                    onChange={(e) =>
                      updateSelected({ text: e.target.value } as any)
                    }
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    value={(selectedBlock as ButtonBlock).href}
                    onChange={(e) =>
                      updateSelected({ href: e.target.value } as any)
                    }
                  />
                </div>
                <div>
                  ...
                  <AlignmentButtons
                    value={(selectedBlock as ButtonBlock).align}
                    onChange={(v) => updateSelected({ align: v } as any)}
                  />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        type="color"
                        className="w-10 h-10 border border-gray-200 rounded-lg cursor-pointer"
                        value={(selectedBlock as ButtonBlock).backgroundColor}
                        onChange={(e) =>
                          updateSelected({
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        type="color"
                        className="w-10 h-10 border border-gray-200 rounded-lg cursor-pointer"
                        value={(selectedBlock as ButtonBlock).textColor}
                        onChange={(e) =>
                          updateSelected({ textColor: e.target.value } as any)
                        }
                      />
                      <input
                        type="text"
                ...
                <div>
                  ...
                  <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                    <input
                      type="number"
                      className="flex-1 px-3 py-2 text-sm outline-none"
                      value={(selectedBlock as ButtonBlock).borderRadius}
                      onChange={(e) =>
                        updateSelected({
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      type="color"
                      className="w-10 h-10 border border-gray-200 rounded-lg cursor-pointer"
                      value={(selectedBlock as DividerBlock).color}
                      onChange={(e) =>
                        updateSelected({ color: e.target.value } as any)
                      }
                    />
                  ...
                  <div>
                    ...
                    <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                      <input
                        type="number"
                        className="flex-1 px-3 py-2 text-sm outline-none"
                        value={(selectedBlock as DividerBlock).thickness}
                        onChange={(e) =>
                          updateSelected({
                  ...
                  <div>
                    ...
                    <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                      <input
                        type="number"
                        className="flex-1 px-3 py-2 text-sm outline-none"
                        value={(selectedBlock as DividerBlock).paddingY}
                        onChange={(e) =>
                          updateSelected({
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="space-y-2 mb-3">
                    {(selectedBlock as SocialBlock).icons.map((icon, idx) => (
                      <div
                        key={idx}
                      ...
                      >
                        ...
                        <select
                          className="flex-1 px-2 py-1 text-xs border border-gray-200 rounded outline-none focus:border-pink-400"
                          value={icon.platform}
                          onChange={(e) => {
                            const newIcons = [
                              ...(selectedBlock as SocialBlock).icons,
                            ];
                            newIcons[idx].platform = e.target.value as any;
                            updateSelected({ icons: newIcons } as any);
                          }}
                        >
                        ...
                        <button
                          ...
                          onClick={() => {
                            const newIcons = (
                              selectedBlock as SocialBlock
                            ).icons.filter((_, i) => i !== idx);
                            updateSelected({ icons: newIcons } as any);
                          }}
                  ...
                  <button
                    ...
                    className="w-full py-2 text-xs font-medium border border-gray-200 rounded-lg hover:border-pink-300 hover:bg-pink-50 text-gray-600 hover:text-pink-700 transition-colors"
                  >
                    + Add Icon
                  </button>
                </div>
                <div>
                  ...
                  <AlignmentButtons
                    value={(selectedBlock as SocialBlock).align}
                    onChange={(v) => updateSelected({ align: v } as any)}
                  />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                      <input
                        type="number"
                        className="flex-1 px-3 py-2 text-sm outline-none"
                        value={(selectedBlock as SocialBlock).iconSize}
                        onChange={(e) =>
                          updateSelected({
                  ...
                  <div>
                    ...
                    <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                      <input
                        type="number"
                        className="flex-1 px-3 py-2 text-sm outline-none"
                        value={(selectedBlock as SocialBlock).spacing}
                        onChange={(e) =>
                          updateSelected({
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    value={(selectedBlock as ColumnsBlock).columnCount}
                    onChange={(e) => {
                      const count = Number(e.target.value) as 2 | 3;
                      const currentContent = (selectedBlock as ColumnsBlock)
                        .content;
                      const newContent =
                        count === 2
                          ? currentContent.slice(0, 2)
                          : [
                              ...currentContent,
                ...
                <div>
                  ...
                  <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                    <input
                      type="number"
                      className="flex-1 px-3 py-2 text-sm outline-none"
                      value={(selectedBlock as ColumnsBlock).gap}
                      onChange={(e) =>
                        updateSelected({ gap: Number(e.target.value) } as any)
                      }
                    />
                    <span className="px-2 py-2 bg-gray-50 text-gray-500 text-sm border-l">
                      px
                ...
                {(selectedBlock as ColumnsBlock).content.map((_, idx) => (
                  <div key={idx}>
                    <label className="block text-xs font-medium text-gray-600 mb-1.5">
                      Column {idx + 1} Content
                    </label>
                    <textarea
                      className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm outline-none focus:border-pink-400 font-mono"
                      rows={3}
                      value={(selectedBlock as ColumnsBlock).content[idx]}
                      onChange={(e) => {
                        const newContent = [
                          ...(selectedBlock as ColumnsBlock).content,
                        ];
                        newContent[idx] = e.target.value;
                        updateSelected({ content: newContent } as any);
                      }}
                ...
                <div>
                  ...
                  <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                    <input
                      type="number"
                      className="flex-1 px-3 py-2 text-sm outline-none"
                      value={(selectedBlock as SpacerBlock).height}
                      onChange={(e) =>
                        updateSelected({
